...
class WithdrawalController extends Controller
{
    ...
    public function handle(Request $request)
    {
        ...
        //     ->get();
        $limited = Withdraw::where('created_at', '>=', Carbon::now()->subDay())->get();
            ...
            if ($user->vip == 1) {
                ...
                if ($request->amount > $wallet->withdrawable_balance) {
                    ...
                    return response()->json([
                        ...
                        'deposit' => $wallet->deposit,
                        'withdrawable_balance' => $wallet->withdrawable_balance,
                        'message' => 'Users on level 0 cannot spend more than 500 units of money.'
                    ]);
                } else {
            ...
            if ($user->vip == 7) {
                ...
                if ($request->amount > $wallet->withdrawable_balance) {
                    ...
                    return response()->json([
                        ...
                        'deposit' => $wallet->deposit,
                        'withdrawable_balance' => $wallet->withdrawable_balance,
                        'message' => 'Users on level 7 cannot spend more than 5000 units of money.'
                    ]);
                } else {
